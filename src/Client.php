...
class Client extends Base
{
            ...
            if (is_array($return) && isset($return['faultcode'])) {
                ...
                if (is_array($return['faultstring'])) {
                    if (isset($return['faultstring']['!'])) {
                        $return['faultstring'] = $return['faultstring']['!'];
                    } else {
                        $return['faultstring'] = implode("\n", $return['faultstring']);
                    }
                }
                throw new FaultException("{$return['faultcode']}: {$return['faultstring']}");
    ...
    * @access   public
    */
    public function setCredentials($username, $password, $authtype = 'basic', array $certRequest = [])
    {
